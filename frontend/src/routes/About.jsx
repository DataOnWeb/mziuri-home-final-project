...
const About = () => {
  ...
  return (
   <div>
        ...
        <div className="container">
          ...
          <div className="signature">
            <div className="signature-text">
              <img src={Calligraphy} alt="Signature" />
            </div>
          </div>
          {/* Features Grid */}
          ...
          <div className="team-section">
            ...
            <div className="team-grid">
              {teamMembers.map((member, index) => (
                <div key={member.id} className={`team-member ${index % 2 === 1 ? 'team-member-bottom' : 'team-member-top'}`}>
      ...
      {/* Video Modal */}
      {isVideoModalOpen && (
        <div className="about-video-modal-overlay" onClick={closeVideoModal}>
          <div className="about-video-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="about-video-modal-close" onClick={closeVideoModal}>
              <X className="w-6 h-6" />
            </button>
